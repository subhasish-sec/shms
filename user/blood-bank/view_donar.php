                            ...
                            <div class="card-body">
                                        ...
                                        <div class="profile-det-info">
                                            ...
                                            <div class="patient-details">
                                                ...
                                                <h5 class="mb-0"><i class="fas fa-map-marker-alt"></i>
                                                    <?= ucfirst($row_donar_data->donar_location) ?></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="patient-info">
                                    ...
                                    <ul>
                                        ...
                                        <li>Age <span><?= getAge($row_donar_data->donar_dob) ?> Years,
                                                <?= ucfirst($row_donar_data->donar_gender) ?></span></li>
                                        <li>Pincode <span><?= $row_donar_data->donar_pincode ?></span></li>
                                        <li>Address <span>
                                                <address><?= $row_donar_data->donar_address ?></address>
                                            </span></li>
                                        <li>Blood Group <span class="text-primary"><strong><?= strtoupper($row_donar_data->donar_blood_group) ?></strong></span>
                                        </li>
                                    </ul>
